...
<html>
	...
	<aside id="fh5co-hero" class="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(../../images/<?php echo $randomLaptops[0][14]; ?>);">
		   	...
		   	<li style="background-image: url(../../images/<?php echo $randomLaptops[1][14]; ?>);">
		   		<div class="container">
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<div class="desc">
		   	...
		   	<li style="background-image: url(../../images/<?php echo $randomLaptops[2][14]; ?>);">
		   		<div class="container">
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<div class="desc">
		   	...
		   	<li style="background-image: url(../../images/<?php echo $randomLaptops[3][14]; ?>);">
		   		<div class="container">
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<div class="desc">
			...
			<div class="row">
				<div class="col-md-4 col-sm-4 text-center">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Branded Model</h3>
						<p>Kami Menampilkan Laptob dengan merek-merek yang sudah terkenal dan di percayai.</p>
				...
				<div class="col-md-4 col-sm-4 text-center">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Save Money</h3>
						<p>Produk yang kami upload / post adalah harga dari website utama , jadi bisa di pastikan harga yang kami beri adalah yang termurah.</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 text-center">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Free Searching</h3>
						<p>Kami menyediakan website pencarian laptob dengan gratis , tanpa memerlukan user untuk melakukan sign up.</p>
					</div>
				</div>
			</div>
		</div>
