				...
				<div class="row animate-box">
					<div class="col-md-6">
						...
						<div class="desc">
							...
							<p>Melakukan yang terbaik biar dosen bangga sama kami #GroupHitamGanteng</p>
						</div>
					</div>
					<div class="col-md-6">
						<img class="img-responsive" src="images/trucash-page-banner-background.png" alt="about">
					</div>
				</div>
			</div>
			<div class="row animate-box">
